...
const nextConfig = {
  ...
  async headers() {
    ...
    const csp = [
      ...
      // PhonePe's redirect flow POSTs the browser onward to mercury and to bank
      // ACS pages; 'self' alone would block the hand-off.
      "form-action 'self' https://mercury.phonepe.com https://mercury-stg.phonepe.com https://*.phonepe.com",
      ...
      // bundle talks to.
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://checkout.razorpay.com https://*.razorpay.com https://mercury.phonepe.com https://mercury-stg.phonepe.com https://*.phonepe.com https://maps.googleapis.com https://accounts.google.com https://verify.msg91.com https://control.msg91.com https://*.msg91.com https://pass.hostnsoft.com https://*.hostnsoft.com",
      ...
      "connect-src 'self' https://api.razorpay.com https://lumberjack.razorpay.com https://*.razorpay.com https://api.phonepe.com https://api-preprod.phonepe.com https://mercury.phonepe.com https://mercury-stg.phonepe.com https://*.phonepe.com https://maps.googleapis.com https://nominatim.openstreetmap.org https://*.tile.openstreetmap.org https://control.msg91.com https://verify.msg91.com https://*.msg91.com https://pass.hostnsoft.com https://*.hostnsoft.com",
